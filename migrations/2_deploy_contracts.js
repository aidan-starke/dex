...
module.exports = async function (deployer, _network, accounts) {
  ...
  await dex.createLimitOrder(ZRX, 2500, 8, SIDE.BUY, { from: trader1 })
  await dex.createMarketOrder(ZRX, 2500, SIDE.SELL, { from: trader2 })
  await increaseTime(1)
  await dex.createLimitOrder(ZRX, 800, 6, SIDE.BUY, { from: trader1 })
  await dex.createMarketOrder(ZRX, 800, SIDE.SELL, { from: trader2 })
  await increaseTime(1)
  await dex.createLimitOrder(ZRX, 300, 7, SIDE.BUY, { from: trader1 })
  await dex.createMarketOrder(ZRX, 300, SIDE.SELL, { from: trader2 })
  await increaseTime(1)
  await dex.createLimitOrder(ZRX, 1200, 6, SIDE.BUY, { from: trader1 })
